...
function b2prettyPrint(){
    if(!b2_global.prettify_load) return
...
var postType5 = new Vue({
    ...
    mounted(){
        ...
        let order_id = store.get('b2_guest_buy_'+post_id+'_v')
        if(order_id){
...
function showHideContent(){
    ...
    if(box.length > 0){
        ...
        let order_id = store.get('b2_guest_buy_'+b2_global.post_id+'_w')
    ...
    methods:{
        resetUserInfo(){
            ...
            if(!b2token){
                ...
                this.show.info = this.data.user_name ? false : true
            }else{
                this.userData = {
...
var b2DownloadBox = new Vue({
    ...
    methods:{
        getList(){
            ...
            let guest = store.get('b2_guest_buy_'+b2_global.post_id+'_x')
            let data = {
                'post_id':b2_global.post_id,
                'guest':guest
            }
